...
let NAMES = {
	...
	faceHandsBrightness: "Face Brightness",
	eyeBrightness: "Eye Brightness",
	lineCount: "Lines",
	glitch: "Glitch",
	zoom: "Zoom"
}
...
document.addEventListener("DOMContentLoaded", function(){
	...
	new Vue({
		...
		<div id="mask-controls">
			<button @click="toggleHandsFree" >Face Recognition</button>
			...
			<div id="mask-slider-container">
				<div id="mask-slider" v-for="(value,label in sliders">
					<label>{{names[label]}}</label>
					<div class="mask-slider-inp">
